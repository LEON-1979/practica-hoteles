module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        browsewrSync: {
            dev: {
                ...
                options: {
                    watchTask: true,
                    server: {
                        baseDir: './' //diretorio base paranuestro servidor
                    }
                }
            }
        },
        ...
        filerev: {
            ...
            release: {
                //filerev:release hashes(md5) all assets (imagenes, js and css )
                //in dist directory
                files: [{
                    src: [
                        'dist/js/*.js',
...
grunt.registerTask('default', ['browserSycn', 'watch'])
